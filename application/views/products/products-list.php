						...
						<div class="page-header">
							...
							<div class="d-flex">
								<div class="justify-content-center">
									...
									<a  class="btn btn-primary my-2 btn-icon-text" href="<?php echo base_url(); ?>Product/add">Add Product</a>
								</div>
							</div>
								...
								<div class="card custom-card">
									<div class="card-body">
										<div>
											...
											<p class="text-muted card-sub-title">This are all products you added</p>
										</div>
											...
											<table class="table" id="example2">
												...
												<tbody>
													...
													<tr>
														...
														<td><img src="<?php echo $p['image']; ?>" height="75"></td>
														<!-- <td><?php echo $p['row_order']; ?></td> -->
														<td>
																		<a href="<?php echo base_url(); ?>Product/variants/<?php echo $p['id']; ?>" class="btn btn-success btn-sm">Variant and Attributes</a>
																		<a href="<?php echo base_url(); ?>Product/delete/<?php echo $p['id']; ?>" class="btn btn-danger btn-sm">Delete</a>
																		<a href="<?php echo base_url(); ?>Product/edit/<?php echo $p['id']; ?>" class="btn btn-info btn-sm">Edit</a>
