					...
					<div class="inner-body">
						...
						<div class="row row-sm">
							<div class="col-md-12">
								...
								<div class="col-lg-12">
									<form action="<?php echo base_url(); ?>Categories/add_category" method="POST" enctype="multipart/form-data" id="myForm">
										<div class="card custom-card">
											<div class="card-body">
												<div class="row row-sm">
													...
													<div class="col-md-6">
														<div class="form-group">
															<p class="mg-b-10">Parent Category ( Select only if you are adding sub category)</p>
															<select name="parent_id" id="parent_id" class="form-control select2">
																<option value="0" <?php if(isset($data['parent_id']) && $data['parent_id'] == '0'){ echo 'selected'; } ?> >Select Parent Category</option>
																<?php foreach ($categories as $cat) { ?>
																	
																<option value="<?php echo $cat['id']; ?>" <?php if(isset($data['parent_id']) && $data['parent_id'] == $cat['id']){ echo 'selected'; } ?> ><?php echo $cat['name']; ?></option>
																<?php } ?>
															</select>
														</div>
													</div>
													<div class="col-md-6">
														<div class="form-group">
															<p class="mg-b-10">Category Order</p>
															<input type="text" class="form-control " name="order" id="order" placeholder="Category Order"  value="<?php if(isset($category)){ echo $category['row_order'];} ?>">
														</div>
													</div>
													<div class="col-md-6">
														<div class="form-group" >
													...
													<div class="col-md-6">
														<div class="form-group row justify-content-center mb-0">
															...
															<img  id="img-preview" src="<?php echo base_url().$category['image']; ?>" height="250">
															 	<?php }else{ ?>
